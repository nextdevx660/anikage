...
export default function page() {
          ...
          useEffect(() => {
                    const getData = async () => {
                              ...
                              try {
                                        const res = await axios.get(`https://anime-api-zeta-hazel.vercel.app/api/most-favorite?page=${currentPage}`);
          ...
          const handlePageChange = (page) => {
                    if (page !== currentPage && page >= 1 && page <= totalPages) {
                              router.push(`/most-favorite?page=${page}`);
                    }
          };
          ...
          return (
                    <div className="bg-[#2d2b2c] pt-15 min-h-screen">
                              {loading ? (
                                        ...
                                        <>
                                                  <div>
                                                            <h2 className='text-2xl text-green-200 font-semibold mb-3 px-3'>Most Favorite</h2>
