...
export default function page() {
          ...
          useEffect(() => {
                    const getData = async () => {
                              ...
                              try {
                                        const res = await axios.get(`https://anime-api-zeta-hazel.vercel.app/api/subbed-anime?page=${currentPage}`);
          ...
          const handlePageChange = (page) => {
                    if (page !== currentPage && page >= 1 && page <= totalPages) {
                              router.push(`/subbed-anime?page=${page}`);
                    }
          };
          ...
          return (
                    <div className="bg-[#2d2b2c] pt-15 min-h-screen">
                              {loading ? (
                                        ...
                                        <>
                                                  <div>
                                                            <h2 className='text-2xl text-green-200 font-semibold mb-3 px-3'>Subbed Anime</h2>
