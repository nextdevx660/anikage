...
import GenreCard from '@/app/_components/GenreCard'
...
export default function page() {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      try {
        const res = await axios.get(`https://anime-api-zeta-hazel.vercel.app/api/genre/${params.genre}?page=${currentPage}`);
  ...
  const handlePageChange = (page) => {
    if (page !== currentPage && page >= 1 && page <= totalPages) {
      router.push(`/genres/${params.genre}?page=${page}`);
    }
  };
  ...
  return (
    <div className='md:flex bg-neutral-950 pt-15'>
      <div className="bg-neutral-950 min-h-screen px-4">
        {loading ? (
