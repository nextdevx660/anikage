...
export default function page() {
          ...
          useEffect(() => {
                    const getData = async () => {
                              ...
                              try {
                                        const res = await axios.get(`https://anime-api-zeta-hazel.vercel.app/api/recently-updated?page=${currentPage}`);
          ...
          return (
                    <div className="bg-neutral-950 pt-15 min-h-screen">
                              {loading ? (
                                        ...
                                        <>
                                                  <div>
                                                            <h2 className='text-2xl text-green-200 font-semibold mb-3 px-3'>Recently Updated</h2>
