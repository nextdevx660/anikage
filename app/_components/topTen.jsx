                                        ...
                                        <Link href={'/' + item?.id} key={index} className="flex items-center gap-4 cursor-pointer">
                                                            <div className={
                                                                      (index === 0 || index === 1 || index === 2)
                                                                                ? `text-xl font-bold text-white w-8 border-b-2 border-green-200 flex items-center justify-center`
                                                            ...
                                                            />}
                                                            <div>
                                                                      <div className="font-semibold text-white leading-snug hover:text-green-200">{item.title}</div>
