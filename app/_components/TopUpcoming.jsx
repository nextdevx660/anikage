...
export default function TopUpcoming() {
          ...
          return (
                    <div className='px-3 mt-5'>
                              <h2 className='text-2xl text-rose-500 font-bold py-3 flex items-center justify-between'>Top Upcoming
                                        <span>
                                                                      ...
                                                                      <div>
                                                                                <div className='relative'>
                                                                                          ...
                                                                                          <div className='absolute bottom-4 left-2 flex items-center gap-1'>
                                                                                                    {item?.tvInfo?.sub &&<h2 className='bg-rose-500 px-1 py-0.5 text-white text-[12px] rounded-md flex items-center gap-1'><BsFillBadgeCcFill size={15} /> {item?.tvInfo.sub}</h2>}
