...
export default function LatestEpisodes() {
          ...
          return (
                    <div className='px-3 mt-5'>
                              <h2 className='text-2xl text-rose-500 font-bold py-3 flex items-center justify-between'>Latest Episodes
                                        <span>
                                                  <Link href={'/recently-updated'} className='flex items-center gap-2 text-gray-500 text-[15px]'>
                                                            View More
